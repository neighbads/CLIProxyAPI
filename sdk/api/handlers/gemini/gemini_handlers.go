...
func (h *GeminiAPIHandler) GeminiModels(c *gin.Context) {
	rawModels := h.FilterModelsForAPIKeyPolicy(c, h.Models())
...
func (h *GeminiAPIHandler) GeminiGetHandler(c *gin.Context) {
	...
	// The per-client filter is applied here too so a hidden model cannot be
	// probed through the single-model endpoint.
	availableModels := h.FilterModelsForAPIKeyPolicy(c, h.Models())
